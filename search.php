...
<br><br><br><br>
<table border=1 class="center" width=400px>
	<tr>
		<td>
			<form action="index.php">
			<label for="search_value"><b><center>Search a Value</center></b></label>
		</td>
	</tr>
	<tr>
		<td>
...
<table border=1 class="center" width=400px>
	<tr>
		<td>
			<form action="index.php">
				<label for="search_value"><b><center>Search reports based on a date</center></b></label>
		</td>
	</tr>
	<tr>
		<td>
...
echo "<center>
<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse; width: 80%; margin: 1.5em; font-family: Arial, Helvetica, sans-serif; font-size: 0.85em;' class=center>
	<tbody>
	<tr>
